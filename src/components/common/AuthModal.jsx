...
const [password, setPassword] = useState("");
    ...
    return (
        ...
        >
            ...
            >
                {/* Header */}
                <div className="relative bg-gradient-to-r from-[#1B5E20] to-[#2E7D32] px-5 py-6 text-center">
                    <button
                        onClick={onClose}
                    ...
                    <h2 className="text-xl font-bold text-white font-[family-name:var(--font-playfair)]">Welcome to Arshi Naturals</h2>
                    <p className="mt-1 text-xs text-green-100">Login or create an account to shop</p>
                </div>
